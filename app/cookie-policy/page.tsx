...
export const metadata: Metadata = {
	title: "Cookies Policy | Jamnia's Bridal",
	description: "Cookies Policy | Jamnia's Bridal",
	applicationName: "Jamnia's Bridal",
	keywords: ["Cookies Policy", "Jamnia's Bridal"],
	openGraph: {
		title: "Cookies Policy | Jamnia's Bridal",
		description: "Cookies Policy | Jamnia's Bridal",
	},
		...
		<div className="mt-10 md:mt-0">
			...
			<div className="container p-container-base pt-8  md:p-container-lg">
				<Text className="text-base leading-relaxed">
					...
					<br />
					Jamnia's Bridal (“us”, “we”, or “our”) uses cookies on our website
					MYFOODANGELS.COM (the “Service”). By using the Service, you consent to
					the use of cookies as described in this Cookies Policy. This Policy
					explains what cookies are, how we use them, how third-parties we may
					partner with use them, your choices regarding cookies, and further
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					<ul className="mt-2 list-inside list-disc">
						<li>
							...
							essential for the Service to function and enable you to use the
							features of the Service. Without these cookies, we cannot provide
							the requested services. We use these cookies to:
							<ul className="mt-2 list-inside list-disc">
								<li>
								...
								<li>
									Ensure you connect to the right service on the
									MYFOODANGELS.COM when we make any changes to the way it works.
								</li>
							</ul>
						</li>
						<li>
							<strong>Performance Cookies:</strong> These cookies collect
							information about how you use MYFOODANGELS.COM, such as which
							pages you visit and if you experience any errors. These cookies
							help us improve the Service and understand user interests. We use
							performance cookies to:
							<ul className="mt-2 list-inside list-disc">
								<li>
									Carry out web analytics and provide statistics on how
									MYFOODANGELS.COM is used.
								</li>
								<li>
									Perform affiliate tracking and provide feedback to affiliated
									entities.
								</li>
								<li>
									Obtain data on the number of users of MYFOODANGELS.COM who
									have viewed a product or service.
								</li>
								<li>
									Help us improve MYFOODANGELS.COM by measuring any errors that
									occur and testing different designs.
								</li>
							</ul>
						</li>
						<li>
							<strong>Functionality Cookies:</strong> These cookies are used to
							remember your settings and preferences to enhance your visit. We
							use functionality cookies to:
							<ul className="mt-2 list-inside list-disc">
								<li>
						...
						<li>
							<strong>Targeting Cookies:</strong> These cookies track your visit
							to MYFOODANGELS.COM and other websites, apps, and online services,
							including the pages you have visited and the links you have
							followed. We may use targeting cookies to:
							<ul className="mt-2 list-inside list-disc">
								<li>Display targeted ads within MYFOODANGELS.COM.</li>
								<li>
									Improve how we deliver personalized ads and content, and
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					advertisements on and through the Service, and more.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
