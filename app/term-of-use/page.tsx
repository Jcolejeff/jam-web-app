...
export const metadata: Metadata = {
	title: "Terms Of Use | Jamnia's Bridal",
	description: "Terms Of Use | Jamnia's Bridal",
	applicationName: "Jamnia's Bridal",
	keywords: ["Terms Of Use | Jamnia's Bridal", "food"],
	openGraph: {
		title: "Terms Of Use | Jamnia's Bridal",
		description: "Terms Of Use | Jamnia's Bridal",
	},
		...
		<div className="mt-10 md:mt-0">
			...
			<div className="container p-container-base pt-8  md:p-container-lg">
				<Text className="text-base leading-relaxed">
					<strong>PLEASE READ!</strong> MYFOODANGELS.COM REQUIRES CONSIDERATION
					FOR AND AS A CONDITION OF ALLOWING YOUR USE OF MYFOODANGELS.COM.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					BY ACCESSING OR USING THIS SITE YOU REPRESENT THAT YOU HAVE THE FULL
					AUTHORITY TO ACT TO BIND YOURSELF, ANY THIRD PARTY, COMPANY, OR LEGAL
					ENTITY, AND THAT YOUR USE AND/OR INTERACTION, AS WELL AS CONTINUING TO
					USE OR INTERACT, WITH THE SITE CONSTITUTES YOUR HAVING READ AND AGREED
					TO THESE TERMS OF USE AS WELL AS OTHER AGREEMENTS THAT WE MAY POST ON
					THE SITE.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					BY VIEWING, VISITING, USING, OR INTERACTING WITH MYFOODANGELS.COM OR
					...
					PRIVACY POLICY OF MYFOODANGELS.COM.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					MYFOODANGELS.COM SPECIFICALLY DENIES ACCESS TO ANY INDIVIDUAL THAT IS
					COVERED BY THE CHILDREN’S ONLINE PRIVACY PROTECTION ACT (COPPA) OF
					1998.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					MYFOODANGELS.COM RESERVES THE RIGHT TO DENY ACCESS TO ANY PERSON OR
					VIEWER FOR ANY LAWFUL REASON. UNDER THE TERMS OF THE PRIVACY POLICY,
					WHICH YOU ACCEPT AS A CONDITION FOR VIEWING, MYFOODANGELS.COM IS
					ALLOWED TO COLLECT AND STORE DATA AND INFORMATION FOR THE PURPOSE OF
					EXCLUSION AND FOR MANY OTHER USES.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					THIS TERMS OF USE AGREEMENT MAY CHANGE FROM TIME TO TIME. VISITORS
					HAVE AN AFFIRMATIVE DUTY, AS PART OF THE CONSIDERATION FOR PERMISSION
					TO ACCESS MYFOODANGELS.COM, TO KEEP THEMSELVES INFORMED OF SUCH
					CHANGES BY REVIEWING THIS TERMS OF USE PAGE EACH TIME THEY VISIT
					MYFOODANGELS.COM.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					of this website. By accessing the contents of this website, you agree
					to this condition of access and you acknowledge that any unauthorized
					use is unlawful and may subject you to civil or criminal penalties.
					...
					contain, for any reason or for any use whatsoever. In recognition of
					the fact that it may be difficult to quantify the exact damages
					arising from infringement of this provision, Visitor agrees to
					compensate the owners of MYFOODANGELS.COM with liquidated damages in
					the amount of U.S. $100,000, or, if it can be calculated, the actual
					costs and actual damages for breach of this provision, whichever is
					greater. Visitor warrants that he or she understands that accepting
					this provision is a condition of accessing MYFOODANGELS.COM and that
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					reason. Furthermore, you are not permitted to reference the URL
					(website address) of this website or any page of this website in any
					commercial or non-commercial media without express permission from us,
					nor are you allowed to ‘frame’ the site. You specifically agree to
					...
					provision. In recognition of the fact that it may be difficult to
					quantify the exact damages arising from infringement of this
					provision, you agree to compensate the owners of MYFOODANGELS.COM with
					liquidated damages in the amount of U.S. $100,000, or, if it can be
					calculated, the actual costs and actual damages for breach of this
					provision, whichever is greater. You warrant that you understand that
					accepting this provision is a condition of accessing MYFOODANGELS.COM
					and that accessing MYFOODANGELS.COM constitutes acceptance.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					<strong>DISCLAIMER FOR CONTENTS OF SITE</strong>
					MYFOODANGELS.COM disclaims any responsibility for the accuracy of the
					content appearing at, linked to on, or mentioned on MYFOODANGELS.COM.
					Visitors assume all risk relating to viewing, reading, using, or
					relying upon this information. Unless you have otherwise formed an
					express contract to the contrary with us, you have no right to rely on
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					VISITOR ASSUMES ALL RISK OF VIRUSES, WORMS, OR OTHER CORRUPTING
					FACTORS. We assume no responsibility for damage to computers or
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					Visitor downloads information from this site at his own risk. Website
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					jurisdictions that may now allow for these exclusions our maximum
					liability will not exceed the amount paid by you, if any, for using
					our website or service.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					Additionally, you agree not to hold us liable for any damages related
					to issues beyond our control, including but not limited to, acts of
					God, war, terrorism, insurrection, riots, criminal activity, natural
					disasters, disruption of communications or infrastructure, labor
					shortages or disruptions (including unlawful strikes), shortages of
					materials, and any other events which are not within our control.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					<strong>INDEMNIFICATION</strong>
					Visitor agrees that in the event he causes damage to us or a third
					party as a result of or relating to the use of MYFOODANGELS.COM,
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					No additional notice of any kind for any reason is required to be
					given to Visitor and Visitor expressly warrants an understanding that
					the right to notice is waived as a condition for permission to view or
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					county of the owner of MYFOODANGELS.COM. In no case shall the viewer,
					visitor, member, subscriber or customer have the right to go to court
				...
				<Text className="mt-4 text-base leading-relaxed">
					...
					the owner of MYFOODANGELS.COM’s address.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					...
					of the owner of MYFOODANGELS.COM.
				</Text>
				<Text className="mt-4 text-base leading-relaxed">
					...
					<br />
					Contact Email:{" "}
					<a href="mailto:info@myfoodangel.com">info@myfoodangel.com</a>, All
					Rights Reserved.
				</Text>
			</div>
		</div>
