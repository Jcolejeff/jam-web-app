	...
	const testimonials = [
		{
			...
			rating: 5,
			message:
				"My experience with Jamnia's Bridal has been the best,i got my stuffs delivered on time and the customer service was top notch",
...

		{
			...
			rating: 5,
			message:
				"All i can say is, Jamnia's Bridal is great, and also great prices as well.I will definitely be back for more",
			img: "https://images.unsplash.com/photo-1492633423870-43d1cd2775eb?&w=128&h=128&dpr=2&q=80",
		},
		{
			name: "Joshua Abel",
			...
			rating: 4,
			message:
				"I had a great experience with Jamnia's Bridal, the delivery was on time and the customer service was top notch",
			img: "https://images.unsplash.com/photo-1492633423870-43d1cd2775eb?&w=128&h=128&dpr=2&q=80",
		},
	];
	return (
