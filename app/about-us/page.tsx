					...
					<div className="mb-6 flex w-full flex-col items-start justify-between gap-2 md:flex-row">
						<div className="w-full flex-1 p-2">
							...
							<Text className="text-gray-500" size={"sm"} weight={"medium"}>
								...
								The daily post-harvest loss due to the inadequate availability
								of storage and transportation facilities from the farms to the
								markets remains our drive at what we do. We are much more than a
								food delivery service. We are disrupting the whole African
								supply chain, one link at a time. Jamnia's Bridal DOT COM
								LIMITED is a business set up to meet the food requirements of
								today’s people and businesses with little or no time to shop for
								required food items, farmers who need their food to reach the
								consumers who naturally find going to the market a herculean
								task.
							</Text>
						</div>
